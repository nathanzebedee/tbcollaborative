          ...
          <div className="relative -mx-4 overflow-hidden bg-[#faebfe] py-20 px-4 sm:-mx-6 sm:px-6 md:mx-0 md:rounded-5xl md:px-16 xl:px-24 xl:py-36">
            ...
            <div className="relative mx-auto grid max-w-2xl grid-cols-1 gap-x-32 gap-y-14 xl:max-w-none xl:grid-cols-2">
              ...
              <div className='flex items-center'>
                <h3 className="text-lg font-semibold tracking-tight bg-pink-600 text-white rounded-xl py-1 px-4 border-2 border-transparent hover:text-pink-600 hover:bg-transparent hover:border-pink-600 transition-all duration-200">
